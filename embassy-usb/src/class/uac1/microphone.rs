...
impl<'d, D: Driver<'d>> Microphone<'d, D> {
    ...
    pub fn new(
        ...
        // Terminal topology:
        // Input terminal (e.g. from microphone) -> Feature Unit (mute and volume) -> Output terminal (sends audio stream)
        ...
        let streaming_endpoint = alt.alloc_endpoint_in(crate::driver::EndpointType::Isochronous, None, max_packet_size, 1);
